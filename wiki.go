...
var templates = template.Must(template.ParseFiles("tmpl/edit.html", "tmpl/view.html", "tmpl/home.html", "tmpl/create.html"))
var validPath = regexp.MustCompile("^/(edit|save|view)/([a-zA-Z0-9]+)$")
var pagePath = regexp.MustCompile("^/(home|create)/$")
...
func homeHandler(w http.ResponseWriter, r *http.Request) {
	...
	var posts []string
	for _, v := range files {
		a := strings.Split(v.Name(), ".txt")
		posts = append(posts, a[0])
	}

	p := &Home{Title: "home", Body: posts}
...
func main() {
	http.HandleFunc("/home/", pageHandler(homeHandler))
